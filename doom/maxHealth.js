...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/Minesraft2/Blooket-Cheats/main/autoupdate/timestamps/doom/maxHealth.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1692579651535 || iframe.contentWindow.confirm(error)) cheat();
    }
