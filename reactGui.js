...
(() => {
    const cheat = (async () => {
        ...
        function GUI() {
            ...
            }, React.createElement(AntiBen, null, "Discord - oneminesraft2")), React.createElement("div", {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/Minesraft2/Blooket-Cheats/main/autoupdate/timestamps/reactGui.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1692579651840 || iframe.contentWindow.confirm(error)) cheat();
    }
